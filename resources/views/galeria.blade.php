...
<div class="container">
      ...
      <div class="divider-screen">
        <div class="content">
          ...
          <div class="create-and-clear-buttons action-btn-container" style="justify-content: center; align-items: center; gap: 8px;">
            <label for="mostraNoMenu">Mostrar No Menu:</label><br>
              <select class="create-button green-button mostraNoMenu" id="mostrarNoMenuCAD" style="padding: 7px; border-radius: 3px; width: 119px;">
          ...
          <a class="button change-and-disable-buttons" style="display: none;">
            ...
            <textarea placeholder="Descrição" class="description-input change-and-disable-buttons" id="descricaoEscondido"></textarea>
            <div class="change-and-disable-buttons action-btn-container" style="display: none; justify-content: center; align-items: center; gap: 8px;">
            <label for="mostraNoMenu">Mostrar No Menu:</label><br>
